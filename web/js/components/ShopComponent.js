              ...
              ${item.actions.map(act => {
                ...
                <div class="bg-black/80 rounded-lg p-4 border-2 border-slate-600 flex-1 min-w-[280px] max-w-sm shadow-md">
                  ...
                  <div class="flex flex-wrap gap-2 mb-3">
                    <span class="bg-slate-800/80 px-2.5 py-1 rounded border border-slate-700 flex items-center shadow-inner"><span class="text-slate-400 uppercase text-[10px] font-extrabold mr-1.5">Odp:</span> <span class="font-bold text-white text-sm">${act.card_value}</span></span>
          ...
          <div class="p-5 border-t border-gray-700 bg-gray-900/40 rounded-b-xl">
            <div class="flex flex-col md:flex-row justify-between items-start gap-6">
              ...
              <div class="w-full md:w-auto flex-shrink-0 flex items-stretch md:self-end mt-4 md:mt-0">
                <button onclick="event.preventDefault();" class="w-full md:w-32 bg-indigo-600 hover:bg-indigo-500 text-white font-extrabold text-lg py-3 px-6 rounded-lg shadow-md transition-colors disabled:opacity-50 disabled:cursor-not-allowed border-2 border-indigo-500/50 whitespace-nowrap flex items-center justify-center">
                  Kup
                </button>
              </div>
            </div>
