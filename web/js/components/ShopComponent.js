              ...
              ${item.actions
                ...
                <div class="bg-black/80 rounded-lg p-4 border-2 border-slate-600 flex-1 min-w-[280px] max-w-sm shadow-md">
                  ...
                  <div class="flex flex-wrap gap-2 mb-3">
                    ...
                    <span class="bg-slate-800/80 px-2.5 py-1 rounded border border-slate-700 flex items-center shadow-inner"><span class="text-slate-400 uppercase text-[10px] font-extrabold mr-1.5">Traf:</span> <span class="font-bold text-amber-400 text-sm">${act.hit_roll || "-"}</span></span>
                    <span class="bg-slate-800/80 px-2.5 py-1 rounded border border-slate-700 flex items-center shadow-inner"><span class="text-slate-400 uppercase text-[10px] font-extrabold mr-1.5">Obr:</span> <span class="font-bold text-rose-400 text-sm">${act.damage_roll || "-"}</span></span>
