        ...
        selectedActionHtml = `
          <div class="${cardWrapperClasses}">
            ...
            <div class="flex flex-wrap gap-2 mb-2">
              ...
              <span class="bg-slate-800/80 px-2 py-1 rounded border border-slate-700 flex items-center shadow-inner"><span class="text-slate-400 uppercase text-[9px] font-extrabold mr-1">Traf:</span> <span class="font-bold text-amber-400 text-xs">${act.hit_roll || "-"}</span></span>
              <span class="bg-slate-800/80 px-2 py-1 rounded border border-slate-700 flex items-center shadow-inner"><span class="text-slate-400 uppercase text-[9px] font-extrabold mr-1">Obr:</span> <span class="font-bold text-rose-400 text-xs">${act.damage_roll || "-"}</span></span>
